...
for reg in regionu_nr:
    ...
    driver.execute_script('document.getElementById("type").selectedIndex = 1;')
    driver.execute_script('document.getElementById("category").selectedIndex = 3;')
    driver.execute_script('document.getElementById("auction_state").value = "can_register";') 
    ...
    sakumcenamin.send_keys('5000')#Here you can set the starting price. If not needed comment out this line.
    sakumcenamax=driver.find_element_by_xpath('//*[@id="start-price-to"]')
    sakumcenamax.send_keys('90000')#Here you can set the max price. If not needed comment out this line.
    novertejumsmin=driver.find_element_by_xpath('//*[@id="valuation-from"]')
    novertejumsmin.send_keys('5000')
    novertejumsmax=driver.find_element_by_xpath('//*[@id="valuation-to"]')
    novertejumsmax.send_keys('90000')
